...
(function($, deck, undefined) {
	...
	*/
    ...
    $d.bind('deck.init', function() {
        ...
        container.click(function(e){ $[deck]('hideToc'); });
        ...
        $.each($[deck]('getSlides'), function(i, $el) {
            ...
            if (slide.hasClass('preToc') || slide.hasClass('additional') ) return;
    ...
    var TOC = function() {
        ...
        function inc(depth) {
            ...
            if(depth>current_depth)
                for(i=current_depth;i<depth;i++) $c.push(0);
